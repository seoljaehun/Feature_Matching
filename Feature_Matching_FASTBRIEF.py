...
# FAST 알고리즘 객체 생성
feature = cv2.FastFeatureDetector_create(nonmaxSuppression=True)

# BRIEF 기술자 생성
brief = cv2.xfeatures2d.BriefDescriptorExtractor_create()

# 특징점 검출
kp1 = feature.detect(src1, None)
kp2 = feature.detect(src2, None)

# 기술자 계산
kp1, desc1 = brief.compute(src1, kp1)
kp2, desc2 = brief.compute(src2, kp2)
